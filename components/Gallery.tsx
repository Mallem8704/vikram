  ...
  return (
    ...
    >
      <div className="section-container">
        ...
        {/* Responsive Portfolio Masonry/Grid */}
          ...
          {filteredItems.map((item, idx) => {
            ...
            return (
              <div
                ...
                className={cn(
                  "group relative rounded-2xl sm:rounded-3xl overflow-hidden cursor-pointer border border-white/10 hover:border-gold/60 shadow-card-dark transition-all duration-300 bg-[#161616]",
        ...
        {preview ? (
          <div className="mt-10 sm:mt-12 text-center">
            <Link
              href="/gallery"
              className="inline-flex items-center gap-2.5 px-7 py-3.5 rounded-xl bg-gold text-black font-sans font-bold text-sm hover:bg-gold-light transition-all shadow-gold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold"
            >
      ...
      {lightboxIndex !== null && activeImage && (
        <div
          ...
          className="fixed inset-0 z-50 bg-black/95 backdrop-blur-xl flex flex-col justify-between p-3 sm:p-6 select-none animate-fade-in"
        ...
        >
          ...
          >
            ...
            {/* Active Image Container (strictly object-contain to avoid any distortion) */}
            <div className="relative w-full h-[62vh] sm:h-[72vh] md:h-[76vh] rounded-2xl overflow-hidden">
              <Image
                src={activeImage.src}
                alt={activeImage.alt}
                fill

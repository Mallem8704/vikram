    ...
    <div className="min-h-screen bg-black text-ivory flex items-center justify-center pt-24 pb-16 px-4">
      <div className="max-w-md w-full text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          <Link
            href="/"
            className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 py-3.5 bg-gold text-black font-sans font-semibold text-sm rounded-xl hover:bg-gold-light transition-colors shadow-gold"
          >
          ...
          <Link
            href="/rooms"
            className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 py-3.5 border border-white/20 text-ivory font-sans font-medium text-sm rounded-xl hover:bg-white/10 transition-colors"
          >
